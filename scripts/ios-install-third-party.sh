...
fetch_and_unpack glog-0.3.5-glog-0.3.5.tar.gz https://github.com/weinixuehao/glog-0.3.5/archive/glog-0.3.5.tar.gz 3195e12702d7eaa2a9a7aec6a1c13d4dcfe8c65a "\"$SCRIPTDIR/ios-configure-glog.sh\""
